...
#define Body_M(R, M) JNIEXPORT R JNICALL Java_com_ariasaproject_advancerofrpg_physics_box2d_Body_##M
    ...
    Body_M(jlong, jniCreateFixture___3JFFFZSSS) (JNIEnv *, jobject, jlong, jfloat, jfloat, jfloat, jboolean, jshort, jshort, jshort);
    ...
    Body_M(void, applyLinearImpulse) (JNIEnv *, jobject, jfloat, jfloat, jfloat, jfloat, jboolean);
    Body_M(void, applyAngularImpulse) (JNIEnv *, jobject, jfloat impulse, jboolean wake);
    ...
    Body_M(void, jniGetLinearVelocityFromWorldPoint) (JNIEnv *, jobject, jfloat, jfloat, jfloatArray);
    Body_M(void, jniGetLinearVelocityFromLocalPoint) (JNIEnv *, jobject, jfloat, jfloat, jfloatArray);
