...
Body_M(jlong, jniCreateFixture___3JFFFZSSS)(JNIEnv *env, jobject object, jlong shapebodyPtr,
                                            jfloat friction, jfloat restitution, jfloat density,
                                            jboolean isSensor, short filterCategoryBits,
...
Body_M(jlong, jniCreateFixture___3JF)(JNIEnv *env, jobject object, jlong shapebodyPtr,
                                      jfloat density) {
    return (jlong) ((b2Body *) env->GetLongField(object, bodyPtr))->CreateFixture(
            (b2Shape *) shapebodyPtr, density);
}

Body_M(void, setTransform)(JNIEnv *env, jobject object, jfloat positionX, jfloat positionY,
                           jfloat angle) {
    ((b2Body *) env->GetLongField(object, bodyPtr))->SetTransform(b2Vec2(positionX, positionY),
                                                                  angle);
}
...
Body_M(void, applyForce)(JNIEnv *env, jobject object, jfloat forceX, jfloat forceY, jfloat pointX,
                         jfloat pointY, jboolean wake) {
    ((b2Body *) env->GetLongField(object, bodyPtr))->ApplyForce(b2Vec2(forceX, forceY),
                                                                b2Vec2(pointX, pointY), wake);
}

Body_M(void, applyForceToCenter)(JNIEnv *env, jobject object, jfloat forceX, jfloat forceY,
                                 jboolean wake) {
    ((b2Body *) env->GetLongField(object, bodyPtr))->ApplyForceToCenter(b2Vec2(forceX, forceY),
                                                                        wake);
}
...
Body_M(void, applyLinearImpulse)(JNIEnv *env, jobject object, jfloat impulseX, jfloat impulseY,
                                 jfloat pointX, jfloat pointY, jboolean wake) {
    ((b2Body *) env->GetLongField(object, bodyPtr))->ApplyLinearImpulse(b2Vec2(impulseX, impulseY),
                                                                        b2Vec2(pointX, pointY),
                                                                        wake);
}
...
Body_M(void, setMassData)(JNIEnv *env, jobject object, jfloat mass, jfloat centerX, jfloat centerY,
                          jfloat I) {
    b2MassData m;
    m.mass = mass;
    m.center.x = centerX;
...
Body_M(void, jniGetWorldPoint)(JNIEnv *env, jobject object, jfloat localPointX, jfloat localPointY,
                               jfloatArray vals) {
    jfloat *data = (jfloat *) env->GetPrimitiveArrayCritical(vals, 0);
...
Body_M(void, jniGetWorldVector)(JNIEnv *env, jobject object, jfloat localVectorX,
                                jfloat localVectorY, jfloatArray vals) {
    jfloat *data = (jfloat *) env->GetPrimitiveArrayCritical(vals, 0);
...
Body_M(void, jniGetLocalPoint)(JNIEnv *env, jobject object, jfloat worldPointX, jfloat worldPointY,
                               jfloatArray vals) {
    jfloat *data = (jfloat *) env->GetPrimitiveArrayCritical(vals, 0);
...
Body_M(void, jniGetLocalVector)(JNIEnv *env, jobject object, jfloat worldVectorX,
                                jfloat worldVectorY, jfloatArray vals) {
    jfloat *data = (jfloat *) env->GetPrimitiveArrayCritical(vals, 0);
...
Body_M(void, jniGetLinearVelocityFromWorldPoint)(JNIEnv *env, jobject object, jfloat worldPointX,
                                                 jfloat worldPointY, jfloatArray vals) {
    jfloat *data = (jfloat *) env->GetPrimitiveArrayCritical(vals, 0);
...
Body_M(void, jniGetLinearVelocityFromLocalPoint)(JNIEnv *env, jobject object, jfloat localPointX,
                                                 jfloat localPointY, jfloatArray vals) {
    jfloat *data = (jfloat *) env->GetPrimitiveArrayCritical(vals, 0);
