...
public:
    ...
    PixmapData(unsigned int width, unsigned int height, Format format, const unsigned char *pixels, bool scale);
    ~PixmapData();
...
#define Pixmap_M(R, M) JNIEXPORT R JNICALL Java_com_ariasaproject_advancerofrpg_graphics_Pixmap_##M
    ...
    Pixmap_M(void, drawPixmap)(JNIEnv *, jclass, jlong, jint, jint, jint, jint, jint, jint, jint, jint); // @suppress("Type cannot be resolved")
