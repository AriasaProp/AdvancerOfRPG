...
Mesh_M(void, updateShort)(JNIEnv *env, jclass clazz, jshortArray obj_src, jint srcOffset, jobject obj_dst, jint dstOffset, jint numShort)
{
...
Mesh_M(void, updateFloat)(JNIEnv *env, jclass clazz, jfloatArray obj_src, jint srcOffset, jobject obj_dst, jint dstOffset, jint numFloat)
{
    unsigned char *dst = (unsigned char *) (obj_dst ? env->GetDirectBufferAddress(obj_dst) : 0);
