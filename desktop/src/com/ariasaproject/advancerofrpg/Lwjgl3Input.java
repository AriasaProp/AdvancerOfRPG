...
import com.ariasaproject.advancerofrpg.input.Input.Orientation;
import com.ariasaproject.advancerofrpg.input.Input.Peripheral;
import com.ariasaproject.advancerofrpg.input.Input.TextInputListener;
import com.ariasaproject.advancerofrpg.input.InputEventQueue;
...
public class Lwjgl3Input implements Input {
	...
	private GLFWScrollCallback scrollCallback = new GLFWScrollCallback() {
		...
		public void invoke(long window, double scrollX, double scrollY) {
			Lwjgl3Input.this.window.getGraphics().requestRendering();
			if (scrollYRemainder > 0 && scrollY < 0 || scrollYRemainder < 0 && scrollY > 0 || TimeUtils.nanoTime() - lastScrollEventTime > pauseTime) {
