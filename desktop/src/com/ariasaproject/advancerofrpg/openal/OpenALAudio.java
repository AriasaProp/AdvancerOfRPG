...
import com.ariasaproject.advancerofrpg.utils.IntMap;
...
public class OpenALAudio implements Audio {
	...
	private ObjectMap<String, Class<? extends OpenALSound>> extensionToSoundClass = new ObjectMap<String, Class<? extends OpenALSound>>();
	private ObjectMap<String, Class<? extends OpenALMusic>> extensionToMusicClass = new ObjectMap<String, Class<? extends OpenALMusic>>();

	Array<OpenALMusic> music = new Array<OpenALMusic>(false, 1, OpenALMusic.class);
