package com.ariasaproject.advancerofrpg.physics.box2d.graphics;

import com.ariasaproject.advancerofrpg.graphics.g2d.ParticleEmitter;
...
import com.ariasaproject.advancerofrpg.physics.box2d.Fixture;
import com.ariasaproject.advancerofrpg.physics.box2d.RayCastCallback;
...
public class ParticleEmitterBox2D extends ParticleEmitter {
    ...
    /**
     * /**Constructs ParticleEmitterBox2D using bufferedReader. Box2d World is used
     * for rayCasting. Assumes that particles use same unit system that box2d world
     * does.
     *
     * @param world
     * @param reader
     ...
     * World is used for rayCasting. Assumes that particles use same unit system
    ...
    private class ParticleBox2D extends Particle {
        ...
        public void translate(float velocityX, float velocityY) {
            /**
             * If velocities squares summed is shorter than Epsilon it could lead ~0 length
             * rayCast that cause nasty c++ assertion inside box2d. This is so short
             * distance that moving particle has no effect so this return early.
             */
