...
public class PrismaticJoint extends Joint {
     ...
     * (b2PrismaticJoint*)addr; anchor[0] =
     ...
     * b2PrismaticJoint* joint =
     * (b2PrismaticJoint*)addr; anchor[0] =
     * joint->GetLocalAxisA().x; anchor[1] =
     * joint->GetLocalAxisA().y;
     */
     ...
     * b2PrismaticJoint* joint = (b2PrismaticJoint*)addr; return
     ...
     * b2PrismaticJoint* joint =
     * (b2PrismaticJoint*)addr; return
     * joint->GetMotorForce(invDt);
     */
