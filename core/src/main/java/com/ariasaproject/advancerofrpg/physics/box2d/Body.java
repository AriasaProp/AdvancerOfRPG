...
public class Body {
	...
	public Fixture createFixture(FixtureDef def) {
		long fixturebodyPtr = jniCreateFixture(def.shape.addr, def.friction, def.restitution, def.density, def.isSensor, def.filter.categoryBits, def.filter.maskBits, def.filter.groupIndex);
