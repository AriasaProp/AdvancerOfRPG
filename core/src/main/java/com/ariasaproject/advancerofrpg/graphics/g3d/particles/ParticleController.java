...
import com.ariasaproject.advancerofrpg.graphics.g3d.particles.emitters.Emitter;
import com.ariasaproject.advancerofrpg.graphics.g3d.particles.influencers.Influencer;
import com.ariasaproject.advancerofrpg.graphics.g3d.particles.renderers.ParticleControllerRenderer;
...
public class ParticleController implements Json.Serializable, ResourceData.Configurable {
    ...
    public void setTranslation(Vector3 translation) {
        this.transform.set(translation, new Quaternion());
    }
    ...
    public ParticleController copy() {
        ...
        return new ParticleController(this.name, emitter, (ParticleControllerRenderer<?, ?>) renderer.copy(), influencers);
    }
