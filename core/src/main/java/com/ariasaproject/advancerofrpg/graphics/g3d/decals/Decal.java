...
public class Decal {
	 ...
	 * @return Created decal
	 */
	// TODO : it would be convenient if {@link
	// com.ariasaproject.advancerofrpg.graphics.Texture} had a getFormat() method to
	// assume transparency
	// from RGBA,..
	...
	public void setRotationX(float angle) {
		rotation.setFromAxis(1, 0, 0, angle);
		updated = false;
	}
	...
	public void setRotationY(float angle) {
		rotation.setFromAxis(0, 1, 0, angle);
		updated = false;
	}
	...
	public void setRotationZ(float angle) {
		rotation.setFromAxis(0, 0, 1, angle);
		updated = false;
	}
	...
	public void rotateX(float angle) {
		rotator.setFromAxis(1, 0, 0, angle);
	...
	public void rotateY(float angle) {
		rotator.setFromAxis(0, 1, 0, angle);
		rotation.mul(rotator);
		updated = false;
	}
	...
	public void rotateZ(float angle) {
		rotator.setFromAxis(0, 0, 1, angle);
		rotation.mul(rotator);
		updated = false;
	}
