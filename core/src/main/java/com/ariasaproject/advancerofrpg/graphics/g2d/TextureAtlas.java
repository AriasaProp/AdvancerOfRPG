...
import com.ariasaproject.advancerofrpg.graphics.g2d.TextureAtlas.TextureAtlasData.Region;
...
import static com.ariasaproject.advancerofrpg.graphics.Texture.TextureWrap.ClampToEdge;
import static com.ariasaproject.advancerofrpg.graphics.Texture.TextureWrap.Repeat;
...
public class TextureAtlas implements Disposable {
    ...
    public TextureAtlas(String internalPackFile) {
        this(GraphFunc.app.getFiles().internal(internalPackFile));
    }
    ...
    static public class AtlasRegion extends TextureRegion {
         ...
         * then it returns the packedHeight, otherwise it returns the packedWidth.
         */
    ...
    static public class TextureAtlasLoader extends SynchronousAssetLoader<TextureAtlas, TextureAtlasParameter> {
        ...
        @Override
        public TextureAtlas load(AssetContainer assetManager, String fileName, FileHandle file, TextureAtlasParameter parameter) {
        ...
        public Array<AssetDescriptor> getDependencies(String fileName, FileHandle atlasFile, TextureAtlasParameter parameter) {
            ...
            for (Page page : data.getPages()) {
                Texture.TextureParameter params = new Texture.TextureParameter();
