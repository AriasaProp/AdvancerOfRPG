...
import com.ariasaproject.advancerofrpg.scenes2d.utils.BaseDrawable;
import com.ariasaproject.advancerofrpg.scenes2d.utils.Drawable;
import com.ariasaproject.advancerofrpg.scenes2d.utils.NinePatchDrawable;
import com.ariasaproject.advancerofrpg.scenes2d.utils.SpriteDrawable;
import com.ariasaproject.advancerofrpg.scenes2d.utils.TextureRegionDrawable;
import com.ariasaproject.advancerofrpg.scenes2d.utils.TiledDrawable;
import com.ariasaproject.advancerofrpg.utils.Array;
import com.ariasaproject.advancerofrpg.utils.Disposable;
import com.ariasaproject.advancerofrpg.utils.Json;
import com.ariasaproject.advancerofrpg.utils.Json.ReadOnlySerializer;
...
import com.ariasaproject.advancerofrpg.utils.SerializationException;
import com.ariasaproject.advancerofrpg.utils.reflect.ClassReflection;
import com.ariasaproject.advancerofrpg.utils.reflect.Method;
...
public class Skin implements Disposable {
    ...
    public <T> T get(String name, Class<T> type) {
        ...
        ObjectMap<String, Object> typeResources = resources.get(type);
        if (typeResources == null)
            throw new RuntimeException("No " + type.getName() + " registered with name: " + name);
    ...
    public Drawable newDrawable(Drawable drawable) {
        ...
        throw new RuntimeException("Unable to copy, unknown drawable type: " + drawable.getClass());
    }
     ...
     * then using an atlas with images whose resolution matches the UI scale. The
     * skin can then be scaled the opposite amount so that the larger or smaller
    ...
    protected Json getJsonLoader(final FileHandle skinFile) {
        ...
        json.setSerializer(BitmapFont.class, new ReadOnlySerializer<BitmapFont>() {
            ...
            public BitmapFont read(Json json, JsonValue jsonData, Class type) {
                ...
                if (!fontFile.exists())
                    fontFile = GraphFunc.app.getFiles().internal(path);
                if (!fontFile.exists())
                ...
                try {
                    ...
                    if (regions != null)
                        font = new BitmapFont(new BitmapFontData(fontFile), regions, true);
                    else {
                        ...
                        if (region != null)
                            ...
                            if (imageFile.exists())
                                font = new BitmapFont(fontFile, imageFile);
                            else
        ...
        json.setSerializer(TintedDrawable.class, new ReadOnlySerializer() {
            ...
            public Object read(Json json, JsonValue jsonData, Class type) {
                ...
                if (jsonData.has("minWidth")) {
                    int minWidth = json.readValue("minWidth", int.class, jsonData);
                    drawable.setMinWidth(minWidth);
                }
                if (jsonData.has("minHeight")) {
                    int minHeight = json.readValue("minHeight", int.class, jsonData);
