...
public class HorizontalGroup extends WidgetGroup {
     ...
     * the widget widths plus spacing.
     * <p>
     * If true, the widgets will wrap using the width of the horizontal group. The
     * preferred width of the group will be 0 as it is expected that something
    ...
    /**
     * Sets the horizontal alignment of each row of widgets when {@link #wrap()
     * wrapping} is enabled and sets the vertical alignment of widgets within each
     * row. Set to {@link Align#center}, {@link Align#top}, {@link Align#bottom},
     * {@link Align#left}, {@link Align#right}, or any combination of those.
     */
    ...
    /**
     * Adds {@link Align#left} and clears {@link Align#right} for the alignment of
     * each row of widgets when {@link #wrap() wrapping} is enabled.
     */
