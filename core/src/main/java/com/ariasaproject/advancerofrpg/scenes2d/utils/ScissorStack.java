...
public class ScissorStack {
    ...
    public static boolean pushScissors(Rectangle scissor) {
        ...
        if (scissors.size == 0) {
            if (scissor.width < 1 || scissor.height < 1)
                return false;
            GraphFunc.tgf.capabilitySwitch(true, TGF.GL_SCISSOR_TEST);
        } else {
            // merge scissors
        ...
        GraphFunc.tgf.glScissor((int) scissor.x, (int) scissor.y, (int) scissor.width, (int) scissor.height);
        return true;
    }
    ...
    public static Rectangle popScissors() {
        ...
        if (scissors.size == 0)
            GraphFunc.tgf.capabilitySwitch(false, TGF.GL_SCISSOR_TEST);
        else {
    ...
    public static Rectangle getViewport() {
        if (scissors.size == 0) {
            viewport.set(0, 0, GraphFunc.app.getGraphics().getWidth(), GraphFunc.app.getGraphics().getHeight());
            return viewport;
        } else {
            Rectangle scissor = scissors.peek();
