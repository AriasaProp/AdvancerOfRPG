...
public class StrBuilder implements Appendable, CharSequence {
    ...
    public StrBuilder(StrBuilder builder) {
     ...
     * @see String#valueOf(int)
     */
    public StrBuilder append(int value, int minLength) {
     ...
     * @see String#valueOf(int)
     */
    public StrBuilder append(int value, final int minLength, final char prefix) {
     ...
     * @return this builder.
     */
    public StrBuilder append(long value, int minLength) {
        return append(value, minLength, '0');
    }
     ...
     * @return this builder.
     */
    public StrBuilder append(long value, int minLength, char prefix) {
    ...
    public StrBuilder append(CharSequence csq) {
        if (csq == null) {
            ...
            StrBuilder builder = (StrBuilder) csq;
    ...
    public StrBuilder append(StrBuilder builder) {
        if (builder == null)
            appendNull();
        else
            append0(builder.chars, 0, builder.length);
    ...
    public StrBuilder append(StrBuilder builder, int start, int end) {
        if (builder == null)
            appendNull();
        else
     ...
     * @see String#valueOf(char[])
     */
    public StrBuilder insert(int offset, char[] ch) {
        insert0(offset, ch);
        return this;
    }
     ...
     * @see String#valueOf(char[], int, int)
     */
    public StrBuilder insert(int offset, char[] str, int strOffset, int strLen) {
     ...
     */
    public StrBuilder insert(int offset, CharSequence s) {
     ...
     */
    public StrBuilder insert(int offset, CharSequence s, int start, int end) {
     ...
     */
    public StrBuilder replace(String find, String replace) {
     ...
     * Replaces all instances of {@code find} with {@code replace}.
     */
    public StrBuilder replace(char find, String replace) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        StrBuilder other = (StrBuilder) obj;
    ...
    public boolean equalsIgnoreCase(@Null StrBuilder other) {
        if (this == other)
            return true;
        if (other == null)
            return false;
