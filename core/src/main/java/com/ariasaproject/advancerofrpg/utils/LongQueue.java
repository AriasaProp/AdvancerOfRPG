...
/**
 * A resizable, ordered array of longs with efficient add and remove at the
 ...
 * via {@link #removeLast()} and {@link #addFirst(long)}.
 */
public class LongQueue {
	...
	/**
	 * Creates a new LongQueue which can hold 16 values without needing to resize
	 * backing array.
	 */
	public LongQueue() {
		this(16);
	...
	/**
	 * Creates a new LongQueue which can hold the specified number of values without
	...
	/**
	 * Append given value to the tail. (enqueue to tail) Unless backing array needs
	...
	/**
	 * Prepend given value to the head. (enqueue to head) Unless backing array needs
	 * resizing, operates in O(1) time.
	 *
	 * @see #addLast(long)
	 */
