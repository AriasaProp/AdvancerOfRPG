...
public class JsonValue implements Iterable<JsonValue> {
    ...
    static private void indent(int count, StrBuilder buffer) {
    ...
    public String toJson(OutputType outputType) {
        if (isValue())
            return asString();
        StrBuilder buffer = new StrBuilder(512);
        json(this, buffer, outputType);
        return buffer.toString();
    }

    private void json(JsonValue object, StrBuilder buffer, OutputType outputType) {
        if (object.isObject()) {
    ...
    private void prettyPrint(JsonValue object, StrBuilder buffer, int indent, PrettyPrintSettings settings) {
