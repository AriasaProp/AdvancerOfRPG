...
public class GearJoint extends Joint {
	...
	private native long jniGetJoint1(long addr); /*
													 * b2GearJoint* joint = (b2GearJoint*)addr; b2Joint* joint1 =
													 * joint->GetJoint1(); return (jlong)joint1;
													 */
	...
	private native long jniGetJoint2(long addr); /*
													 * b2GearJoint* joint = (b2GearJoint*)addr; b2Joint* joint2 =
													 * joint->GetJoint2(); return (jlong)joint2;
													 */
	...
	private native float jniGetRatio(long addr); /*
													 * b2GearJoint* joint = (b2GearJoint*)addr; return
													 * joint->GetRatio();
													 */
