...
import com.ariasaproject.advancerofrpg.utils.reflect.Field;
import com.ariasaproject.advancerofrpg.utils.reflect.ReflectionException;

public class Json {
	private final ObjectMap<Class, OrderedMap<String, FieldMetadata>> typeToFields = new ObjectMap<Class, OrderedMap<String, FieldMetadata>>();
	...
	/**
	 * When true, fields with the {@link Deprecated} annotation will not be read or
	 ...
	 * not written) when {@link #setIgnoreDeprecated(boolean)} is true. Default is
	 * false.
	 *
	 * @see #setDeprecated(Class, String, boolean)
	 */
	...
	/**
	 * When true, fields are sorted alphabetically when written, otherwise the
	 * source code order is used. Default is false.
	 */
	 ...
	 * with the same name on the <code>from</code> object. The <code>to</code>
	 * object must have at least all the fields of the <code>from</code> object with
