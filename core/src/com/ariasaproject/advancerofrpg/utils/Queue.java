...
public class Queue<T> implements Iterable<T> {
	 ...
	 * is returned each time this method is called. Use the {@link QueueIterator}
	...
	static public class QueueIterable<T> implements Iterable<T> {
		...
		public Iterator<T> iterator() {
			if (iterator1 == null) {
				iterator1 = new QueueIterator<T>(queue, allowRemove);
				iterator2 = new QueueIterator<T>(queue, allowRemove);
