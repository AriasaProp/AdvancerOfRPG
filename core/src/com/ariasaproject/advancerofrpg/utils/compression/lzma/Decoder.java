...
import com.ariasaproject.advancerofrpg.utils.compression.lz.OutWindow;
import com.ariasaproject.advancerofrpg.utils.compression.rangecoder.BitTreeDecoder;

public class Decoder {
	OutWindow m_OutWindow = new OutWindow();
	com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Decoder m_RangeDecoder = new com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Decoder();
	...
	void Init() throws IOException {
		...
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Decoder.InitBitModels(m_IsMatchDecoders);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepDecoders);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG0Decoders);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG1Decoders);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG2Decoders);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Decoder.InitBitModels(m_PosDecoders);
	...
	class LenDecoder {
		...
		public void Init() {
			com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Decoder.InitBitModels(m_Choice);
