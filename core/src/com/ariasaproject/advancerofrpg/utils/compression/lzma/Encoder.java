package com.ariasaproject.advancerofrpg.utils.compression.lzma;

import java.io.IOException;

import com.ariasaproject.advancerofrpg.utils.compression.ICodeProgress;
import com.ariasaproject.advancerofrpg.utils.compression.rangecoder.BitTreeEncoder;
...
public class Encoder {
	...
	com.ariasaproject.advancerofrpg.utils.compression.lz.BinTree _matchFinder = null;
	com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder _rangeEncoder = new com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder();
	...
	void Create() {
		if (_matchFinder == null) {
			com.ariasaproject.advancerofrpg.utils.compression.lz.BinTree bt = new com.ariasaproject.advancerofrpg.utils.compression.lz.BinTree();
			int numHashBytes = 4;
	...
	void Init() {
		BaseInit();
		_rangeEncoder.Init();
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.InitBitModels(_isMatch);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.InitBitModels(_isRep0Long);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.InitBitModels(_isRep);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.InitBitModels(_isRepG0);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.InitBitModels(_isRepG1);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.InitBitModels(_isRepG2);
		com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.InitBitModels(_posEncoders);
	...
	class LenEncoder {
		...
		public void Init(int numPosStates) {
			com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.InitBitModels(_choice);
		...
		public void SetPrices(int posState, int numSymbols, int[] prices, int st) {
			int a0 = com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.GetPrice0(_choice[0]);
			int a1 = com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.GetPrice1(_choice[0]);
			int b0 = a1 + com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.GetPrice0(_choice[1]);
			int b1 = a1 + com.ariasaproject.advancerofrpg.utils.compression.rangecoder.Encoder.GetPrice1(_choice[1]);
			int i = 0;
