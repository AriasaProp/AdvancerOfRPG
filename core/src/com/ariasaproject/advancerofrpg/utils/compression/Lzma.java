...
public class Lzma {
	...
	static public void compress(InputStream in, OutputStream out) throws IOException {
		...
		if (params.Eos)
			eos = true;
		com.ariasaproject.advancerofrpg.utils.compression.lzma.Encoder encoder = new com.ariasaproject.advancerofrpg.utils.compression.lzma.Encoder();
	...
	static public void decompress(InputStream in, OutputStream out) throws IOException {
		...
		com.ariasaproject.advancerofrpg.utils.compression.lzma.Decoder decoder = new com.ariasaproject.advancerofrpg.utils.compression.lzma.Decoder();
