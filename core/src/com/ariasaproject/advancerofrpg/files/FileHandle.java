...
public class FileHandle {
	...
	/**
	 * Returns the file extension (without the dot) or an empty string if the file
	 ...
	 * 
	 * @throws RuntimeException if the file handle represents a directory, doesn't
	...
	/**
	 * Returns a reader for reading this file as characters the platform's default
	 * charset.
	 * 
	 * @throws RuntimeException if the file handle represents a directory, doesn't
	 *                          exist, or could not be read.
	...
	/**
	 * Returns a buffered reader for reading this file as characters using the
	...
	/**
	 * Attempts to memory map this file in READ_ONLY mode. Android files must not be
	 * compressed.
	 * 
	 * @throws RuntimeException if this file handle represents a directory, doesn't
	 *                          exist, or could not be read, or memory mapping
	 *                          fails, or is a {@link FileType#Classpath} file.
	 */
	 ...
	 *               it will be appended.
	 * @throws RuntimeException if this file handle represents a directory, if it is
	 *                          a {@link FileType#Classpath} or
	 *                          {@link FileType#Internal} file, or if it could not
	 *                          be written.
	 */
	...
	/**
	 * @throws RuntimeException if this file handle is a {@link FileType#Classpath}
	 *                          or {@link FileType#Internal} file.
	 */
	public void mkdirs() {
		if (type == FileType.Internal)
	 ...
	 * handle is a directory, then 1) if the destination is a file, RuntimeException
	 * is thrown, or 2) if the destination is a directory, this directory is copied
	 * into it recursively, overwriting existing files, or 3) if the destination
	 * doesn't exist, {@link #mkdirs()} is called on the destination and this
	 * directory is copied into it recursively.
	 * 
