...
import com.ariasaproject.advancerofrpg.math.Plane.PlaneSide;
...
public final class Intersector {
	 ...
	 * @return Whether the line segment and the circle intersect
	 */
	public static boolean intersectSegmentCircle(Vector2 start, Vector2 end, Circle circle,
	 ...
	 *
	 * @param ray          The ray
	 * @param triangles    The triangles, each successive 9 elements are the 3
	 *                     vertices of a triangle, a vertex is made of 3 successive
	 *                     floats (XYZ)
	 ...
	 *
	 * @param ray          The ray
	 * @param triangles    The triangles, each successive 3 elements are the 3
	 *                     vertices of a triangle
	 * @param intersection The nearest intersection point (optional)
	 * @return Whether the ray and the triangles intersect.
	 */
	 ...
	 */
	public static boolean intersectSegmentRectangle(float startX, float startY, float endX, float endY,
			Rectangle rectangle) {
