...
public class VerticalGroup extends WidgetGroup {
	 ...
	 * height is the widget heights plus spacing.
	 * <p>
	 * If true, the widgets will wrap using the height of the vertical group. The
	 * preferred height of the group will be 0 as it is expected that something
	 * external will set the height of the group. Widgets are sized to their
	 * preferred height unless it is larger than the group's height, in which case
	 * they are sized to the group's height but not less than their minimum height.
	 * Default is false.
	 * <p>
	...
	/**
	 * Sets the vertical alignment of each column of widgets when {@link #wrap()
	 * wrapping} is enabled and sets the horizontal alignment of widgets within each
	 * column. Set to {@link Align#center}, {@link Align#top}, {@link Align#bottom},
	 * {@link Align#left}, {@link Align#right}, or any combination of those.
	 */
	 ...
	 * each column of widgets when {@link #wrap() wrapping} is enabled.
	 */
