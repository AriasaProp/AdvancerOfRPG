...
public class OpenGLES30 implements AndroidTGF {
    ...
    public void glDeleteBuffer(int buffer) {
        ints[0] = buffer;
        GLES30.glDeleteBuffers(1, ints, 0);
    }
    ...
    public void glDeleteFramebuffer(int framebuffer) {
        ints[0] = framebuffer;
        GLES30.glDeleteFramebuffers(1, ints, 0);
    }
    ...
    public void glDeleteRenderbuffer(int renderbuffer) {
        ints[0] = renderbuffer;
        GLES30.glDeleteRenderbuffers(1, ints, 0);
    }

    @Override
    public void glDeleteTexture(int texture) {
        ints[0] = texture;
        GLES30.glDeleteTextures(1, ints, 0);
    }
    ...
    public int glGenFramebuffer() {
        GLES30.glGenFramebuffers(1, ints, 0);
        return ints[0];
    }
    ...
    public int glGenRenderbuffer() {
        GLES30.glGenRenderbuffers(1, ints, 0);
        return ints[0];
    }

    @Override
    public int glGenTexture() {
        GLES30.glGenTextures(1, ints, 0);
        return ints[0];
    }
    ...
    public String glGetActiveAttrib(int program, int index, IntBuffer size, Buffer type) {
        ...
        GLES30.glGetActiveAttrib(program, index, buffer.length, ints, 0, ints2, 0, ints3, 0, buffer, 0);
    ...
    public String glGetActiveUniform(int program, int index, IntBuffer size, Buffer type) {
        ...
        // type
        ints3[0] = ((IntBuffer) type).get(0);
        GLES30.glGetActiveUniform(program, index, buffer.length, ints, 0, ints2, 0, ints3, 0, buffer, 0);
        return new String(buffer, 0, ints[0]);
    }

    @Override
    public void glGetAttachedShaders(int program, int maxcount, Buffer count, IntBuffer shaders) {
        GLES30.glGetAttachedShaders(program, maxcount, (IntBuffer) count, shaders);
    }
    ...
    public void glGetBooleanv(int pname, Buffer params) {
        GLES30.glGetBooleanv(pname, (IntBuffer) params);
    }
    ...
    public int glGetIntegerv(int pname) {
        GLES30.glGetIntegerv(pname, ints, 0);
        return ints[0];
    }
    ...
    public void glUniform1fv(int location, int count, float[] v, int offset) {
        GLES30.glUniform1fv(location, count, v, offset);
    }
    ...
    public void glUniform1iv(int location, int count, int[] v, int offset) {
        GLES30.glUniform1iv(location, count, v, offset);
    }
    ...
    public void glUniform2fv(int location, int count, float[] v, int offset) {
        GLES30.glUniform2fv(location, count, v, offset);
    }
    ...
    public void glUniform2iv(int location, int count, int[] v, int offset) {
        GLES30.glUniform2iv(location, count, v, offset);
    }
    ...
    public void glUniform3iv(int location, int count, int[] v, int offset) {
        ...
        GLES30.glUniform3iv(location, count, v, offset);
    }
    ...
    public void glUniform4fv(int location, int count, float[] v, int offset) {
        ...
        GLES30.glUniform4fv(location, count, v, offset);
    }
    ...
    public void glUniform4iv(int location, int count, int[] v, int offset) {
        ...
        GLES30.glUniform4iv(location, count, v, offset);
    }
    ...
    public void glUniformMatrix2fv(int location, int count, boolean transpose, float[] value, int offset) {
        ...
        GLES30.glUniformMatrix2fv(location, count, transpose, value, offset);
    }
    ...
    public boolean glIsFramebuffer(int handler) {
        ...
        return GLES30.glIsFramebuffer(handler);
    }

    @Override
    public boolean glIsTexture(int handler) {
        return GLES30.glIsTexture(handler);
    }
    ...
    public String glVersion() {
        return GLES30.glGetString(GLES30.GL_VERSION);
    }
    ...
    public float getMaxAnisotropicFilterLevel() {
        if (maxAnisotropicFilterLevel == 0) {
            if (supportsExtension("GL_EXT_texture_filter_anisotropic")) {
                ...
                GLES30.glGetFloatv(0x84FF, buffer);
    ...
    public int compileShaderProgram(String source, String prefix) {
        ...
        try {
            ...
            Arrays.fill(handlers, -1);
						tg.glClearColorMask(GLES30.GL_COLOR_BUFFER_BIT|GLES30.GL_DEPTH_BUFFER_BIT|GLES30.GL_STENCIL_BUFFER_BIT, 0, 0, 1.0f, 1.0f);
    ...
    public int[] genMesh(final int max_v_data, final boolean v_static, final int max_i_data, final boolean i_static) {
        ...
        try {
            ...
            // buffers ids
            GLES30.glGenBuffers(2, handlers, 1);
            ...
            // binding vertex
            GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER, handlers[1]);
            GLES30.glBufferData(GLES30.GL_ARRAY_BUFFER, max_v_data, null,
                    v_static ? GLES30.GL_STATIC_DRAW : GLES30.GL_DYNAMIC_DRAW);
            GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER, 0);
            // binding indices
            GLES30.glBindBuffer(GLES30.GL_ELEMENT_ARRAY_BUFFER, handlers[2]);
            GLES30.glBufferData(GLES30.GL_ELEMENT_ARRAY_BUFFER, max_i_data, null,
                    i_static ? GLES30.GL_STATIC_DRAW : GLES30.GL_DYNAMIC_DRAW);
    ...
    public void destroyMesh(int[] handlers) {
        try {
            ...
            GLES30.glDeleteBuffers(2, handlers, 1);
    ...
    public void validateAll() {
        ...
        this.depthFunc = GLES30.GL_LEQUAL;
        this.depthRangeNear = 0;
        this.depthRangeFar = 1;
        this.blendSFactor = GLES30.GL_ONE;
        this.blendDFactor = GLES30.GL_ZERO;
        this.cullFace = GLES30.GL_BACK;
    ...
    public void clear() {
        ...
        for (final int[] handler : shaderPrograms) {
            GLES30.glDeleteProgram(handler[0]);
            GLES30.glDeleteShader(handler[1]);
            GLES30.glDeleteShader(handler[2]);
        }
        shaderPrograms.clear();
        GLES30.glBindVertexArray(0);
        for (final int[] handler : meshes) {
            GLES30.glDeleteVertexArrays(1, handler, 0);
            GLES30.glDeleteBuffers(2, handler, 1);
        }
        meshes.clear();
        enabledCaps.clear();
